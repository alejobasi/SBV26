  ...
  Bullfighting: {
    ...
    cards: [
      ...
      },
      {
        ...
        image: '/toros/14escandaloso_2.jpg',
        fit: 'contain',
        tags: ['Toros por las calles', 'Victorino Martín'],
        group: 'calles',
